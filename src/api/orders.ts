...
// Fake database
let orders: Order[] = [
  { id: "1", customerId: "1", total: 100, status: "pending", createdAt: "2025-04-01" },
  { id: "2", customerId: "2", total: 250, status: "completed", createdAt: "2025-04-05" },
  { id: "3", customerId: "3", total: 75, status: "cancelled", createdAt: "2025-04-10" },
];
...
export const createOrder = async (order: Omit<Order, "id" | "createdAt">): Promise<Order> => {
  await delay(500);
  if (!order.customerId || order.total <= 0) throw new Error("Cliente e total válidos são obrigatórios");
